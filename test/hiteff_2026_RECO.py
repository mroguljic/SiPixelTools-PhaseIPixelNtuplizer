...
#cmsRun hiteff_2026_RECO.py globalTag=160X_dataRun3_Prompt_v1 maxEvents=5000 dataTier=RECO
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run3_2026_cff import Run3_2026

process = cms.Process('RERECO',Run3_2026)
...
if opt.inputFileName == '':
    if opt.dataTier == 'RAW':
        ...
        process.source = cms.Source("PoolSource",
                                    fileNames = cms.untracked.vstring(
                                        '/store/data/Run2026D/ZeroBias/RAW-RECO/LogError-PromptReco-v1/000/403/461/00000/b0e8bd38-1040-4c5c-a2e2-d995b413ec99.root',
                                        '/store/data/Run2026D/ZeroBias/RAW-RECO/LogError-PromptReco-v1/000/403/461/00000/fea68c9c-7794-4ac4-a6ec-f0af5527eef1.root',
                                        '/store/data/Run2026D/ZeroBias/RAW-RECO/LogError-PromptReco-v1/000/403/461/00000/3ef52b17-b74a-405c-b936-c3431754ed7f.root',
                                        '/store/data/Run2026D/ZeroBias/RAW-RECO/LogError-PromptReco-v1/000/403/461/00000/a8fc8189-1303-410c-ba08-f70088590209.root',
                                        '/store/data/Run2026D/ZeroBias/RAW-RECO/LogError-PromptReco-v1/000/403/461/00000/621d0ec7-1a6d-4383-8ca9-57f8b788055c.root',
                                        '/store/data/Run2026D/ZeroBias/RAW-RECO/LogError-PromptReco-v1/000/403/461/00000/fb3a65de-aaee-42eb-988f-6036376845bc.root',
                                        '/store/data/Run2026D/ZeroBias/RAW-RECO/LogError-PromptReco-v1/000/403/461/00000/bcb1e302-c564-429d-8f69-f2a02c4d7850.root',
                                        '/store/data/Run2026D/ZeroBias/RAW-RECO/LogError-PromptReco-v1/000/403/461/00000/65f2da95-d167-431a-9f54-6ee11dcf6c32.root'
						            )
        )
else:
...
process.source.lumisToProcess = LumiList.LumiList(filename = '/work/mrogulji/CMSSW_Ntuplizer_16_0_6/src/SiPixelTools/PhaseIPixelNtuplizer/test/batch/Cert_Collisions2026_Golden_jsons/Collisions26_MLEnhancedGolden_Latest.json').getVLuminosityBlockRange()
...
if opt.useTemplates:
    print("[WARNING]: Using template reco in 2026. It was disabled in data since run 402532. Are you sure you want to do this?")
